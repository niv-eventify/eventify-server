module Netpay
  ...
  class HostedPage
    ...
    def self.validate_response(params)
      ...
      return params[:signature] == Base64.encode64(Digest::SHA256.digest(str_to_signature)).chomp || params[:signature] == Base64.encode64(Digest::MD5.digest(str_to_signature)).chomp
    end
