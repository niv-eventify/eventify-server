...
e=b.children("thead").eq(0).children().eq(0)}else{a=a.find("."+c.markerClass).eq(0);e=b.children().eq(0)}e=e.children().eq(0);a.children().each(function(f,g){e.width(d(g).width());e=e.next()})}function k(b,a){var c=d(b),e=d(window).scrollTop(),f=c.offset().top,g=c.height()-a.height();c=c.children("tfoot");if(c.length>0)g-=c.height();return f<=e&&e<=f+g}d.fn.floatHeader=function(b){b=d.extend({fadeOut:250,faceIn:250,forceClass:false,markerClass:"floating",floatClass:"floatHeader",recalculate:false,
