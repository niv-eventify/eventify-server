      ...
      format.js do
        if params[:change_design]
          ...
          render(:update) do |page|
            page << "jQuery.nyroModalManual({endShowContent: function(){jQuery('.category-selector select').customSelect();}, content: #{render(:partial => "designs/change_design").to_json}, minWidth: 800, minHeight: 550});"
          end
        else
