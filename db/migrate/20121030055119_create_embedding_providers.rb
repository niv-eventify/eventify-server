class CreateEmbeddingProviders < ActiveRecord::Migration
  def self.up
    ...
    EmbeddingProvider.new(:name => "vimeo", :src => "http://player.vimeo.com/video/in_site_id?", :get_params_for_preview => "autoplay=1", :get_params_for_stage2 => "autoplay=0", :html_attrs_for_preview => "{:width=>'889', :height=>'563', :frameborder=>'0', :webkitAllowFullScreen=>true, :mozallowfullscreen=>true, :allowFullScreen=>true}", :html_attrs_for_stage2 => "{:width=>'561', :height=>'374', :frameborder=>'0', :webkitAllowFullScreen=>true, :mozallowfullscreen=>true, :allowFullScreen=>true}").save
  end
